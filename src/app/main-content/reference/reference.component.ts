...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, SingleReferenceComponent, MatCardModule,TranslateModule],
...
export class ReferenceComponent {
  ...
  get currentReference(): Reference {
    return this.references[this.activeIndex];
  }

  get nextReference(): Reference {
    return this.references[(this.activeIndex + 1) % this.references.length];
  }
